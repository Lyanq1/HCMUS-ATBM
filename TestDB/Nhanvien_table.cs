...
namespace TestDB
{
    public partial class Nhanvien_table : UserControl
    {
        ...
        public Nhanvien_table(string manld, string vaitro, string connStr)
        {
            InitializeComponent();
            ConfigureGrid();
            this.manld = manld;
        ...
        private void Nhanvien_table_Load(object sender, EventArgs e)
        {
